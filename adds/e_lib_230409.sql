...
--
-- Host: 127.0.0.1
-- Generation Time:  9 апр 2023 в 01:03
...
(1, 'pbkdf2_sha256$390000$5Nc7u2GdzFUfT56CIJniFE$FFT4yRKPb8CDN63zvAxi0tZbaodytkvT4uiDYO3TGEU=', '2023-04-08 13:49:42.269391', 1, 'admin', '', '', '', 1, 1, '2023-04-02 12:50:55.240524');
...
('6otc5r4jr0xyblewa4lufj4andf0wmt1', '.eJxVjDEOwjAMRe-SGUUOxE1gZOcMkWMbUkCJ1LQT4u5QqQOs_733XybRMpe0dJ3SKOZknNn9bpn4oXUFcqd6a5Zbnacx21WxG-320kSf5839OyjUy7dWFvADogZAhShe0KEXEueQY4TA4rJnuUbwQAzHzMMBAug-qwKweX8A5Es4Dw:1pl8wo:7jdEDCA90Iq9z_B_kodbzbXGJ6wYuf7AYwAj7OF37Ns', '2023-04-22 13:49:42.271389'),
...
(1, 'Приложен файл към предмет', 'attachments/4810201-networks.docx', NULL, 2, NULL),
(2, 'Приложен файл към тема', 'attachments/section4_theme1.ppt', NULL, 2, 1),
(3, 'Приложен файл към  статия', 'attachments/i43_2.png', 1, 2, 1);
...
CREATE TABLE `lib_theme` (
  ...
  `Предемт_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lib_theme` (`id`, `name`, `Номер`, `Предемт_id`) VALUES
...
ALTER TABLE `lib_theme`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lib_theme_Предемт_id_84c69367_fk_lib_subject_id` (`Предемт_id`);
...
ALTER TABLE `lib_attacment`
  ...
  ADD CONSTRAINT `lib_attacment_theme_id_id_d95ca11f_fk_lib_theme_id` FOREIGN KEY (`theme_id_id`) REFERENCES `lib_theme` (`id`);
...
--
ALTER TABLE `lib_theme`
  ADD CONSTRAINT `lib_theme_Предемт_id_84c69367_fk_lib_subject_id` FOREIGN KEY (`Предемт_id`) REFERENCES `lib_subject` (`id`);
COMMIT;
